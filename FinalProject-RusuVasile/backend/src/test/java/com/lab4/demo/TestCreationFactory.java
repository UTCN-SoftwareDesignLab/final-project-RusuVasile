...
public class TestCreationFactory {
    ...
    public static <T> List<T> listOf(Class cls, Object... parameters) {
        ...
        if (cls.equals(UserListDTO.class)) {
            ...
            supplier = TestCreationFactory::newSled;
        }
        else if (cls.equals(Contest.class)) {
            supplier = TestCreationFactory::newContest;
        }
        else {
    ...
    private static Team newSled(){
        return Team.builder()
                .id(randomLong())
                .musherName(randomString())
                .name(randomString())
                .numberOfDogs(randomBoundedInt(10))
                .build();
    }
    private static Contest newContest(){
